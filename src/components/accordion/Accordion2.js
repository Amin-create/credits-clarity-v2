        ...
        return (
          <div className={`${activeIndex === index ? "bg-white" : ""}`}>
            ...
            <div
              ...
              } px-5 py-4 ${isLastItem ? "" : "border-b-[1px]"}`}
              key={value.id}
            >
              <button
                className="text-[16px] leading-[24px] font-bold  text-left"
              ...
              <div
                ...
                className={`hs-accordion-content2 transition-all duration-300  ${
                  activeIndex === index ? "w-full" : "max-h-0"
                }`}
                aria-labelledby={`hs-basic-heading-${index + 1}`}
              >
                <div className="">
                  <p className="text-[14px] leading-[24px] font-regular">
                    {value.description}
                  </p>
                </div>
              </div>
